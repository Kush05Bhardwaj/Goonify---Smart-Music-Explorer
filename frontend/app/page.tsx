      ...
      <div className="relative z-10">
          ...
          >
            ...
            >
              <button
                ...
                className="group relative w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 rounded-2xl font-semibold text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-emerald-500/50"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-4 sm:p-6 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10"
                >
        ...
        <section className="container mx-auto px-6 py-20">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-lg rounded-3xl border border-slate-700 p-6 sm:p-8 md:p-12 text-center"
          >
            <div className="grid grid-cols-3 gap-4 sm:gap-8">
              <div>
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent mb-2">
                  100%
                </div>
                <div className="text-xs sm:text-sm text-slate-400">Free & Open Source</div>
              </div>
              <div>
                ...
                <div className="text-xs sm:text-sm text-slate-400">Features</div>
              </div>
              <div>
                ...
                <div className="text-xs sm:text-sm text-slate-400">Songs to Explore</div>
              </div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-6 sm:mt-8 px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 rounded-xl font-semibold transition-all duration-300 shadow-lg text-sm sm:text-base"
            >
              Get Started Now →
            </motion.button>
          </motion.div>
